...
rec {
  jar = pkgs.fetchurl {
    url = "https://github.com/PapenfussLab/gridss/releases/download/v2.10.1/gridss-2.10.1-gridss-jar-with-dependencies.jar";
    sha256 = "feWLtlzGxn3RNa9fpBoB7AJ+PuSup4lt3eez+M/lUp0=";
  };
